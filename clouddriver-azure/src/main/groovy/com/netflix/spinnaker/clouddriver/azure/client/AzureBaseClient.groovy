...
public abstract class AzureBaseClient {
  ...
  public String getAzureRESTJson(AzureCredentials creds, String baseUrl, String targetUrl, List<String> queryParameters){
    String result = null
    ...
    try {
      ...
      if (statusCode == HttpStatus.SC_OK) {
        ...
        result = IOUtils.toString(responseContent)
      }
    }
    catch (Exception e) {
